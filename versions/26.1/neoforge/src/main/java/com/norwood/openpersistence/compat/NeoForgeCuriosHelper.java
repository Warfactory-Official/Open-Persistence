...
/**
 * Curios integration for NeoForge. Curios is a soft (compile-only) dependency, so every method first
 * checks {@link #isAvailable()} before touching any {@code top.theillusivec4.curios} class.
 */
